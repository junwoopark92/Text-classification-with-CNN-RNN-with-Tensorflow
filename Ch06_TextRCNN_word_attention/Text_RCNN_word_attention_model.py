####################################################
# Text classification with attention RCNN - model (word level)
...
class MODEL():
    ...
    def set_network(self):
        ...
        with tf.variable_scope('LSTMcell'):
            ...
            outputs, _states = tf.nn.dynamic_rnn(cell=multi_cells, inputs=net, dtype=tf.float32) #sequence_length=self.SEQ,
